    ...
    return ValueListenableBuilder<bool>(
      ...
      builder: (_, isLast, __) {
        return IconButton(
          ...
          null
          : () {
            _postsProvider.onNextSongButtonPressed(_postsProvider.recommendersAudioPlayer);
          }, 
        );
      },
    );
        ...
        switch (value) {
          ...
          case ButtonState.paused:
            return IconButton(
              ...
              iconSize: 32.0,
              onPressed: (){
                _postsProvider.play(_postsProvider.recommendersAudioPlayer);
              },
            );
          case ButtonState.playing:
            return IconButton(
              ...
              iconSize: 32.0,
              onPressed: () {
                _postsProvider.pause(_postsProvider.recommendersAudioPlayer);
              },
            );
        }
      },
    ...
    return ValueListenableBuilder<bool>(
      ...
      builder: (_, isFirst, __){
        return IconButton(
          ...
          null
          : (){
            _postsProvider.onPreviousSongButtonPressed(_postsProvider.recommendersAudioPlayer);
          },
    ...
    return ValueListenableBuilder<RepeatState>(
      ...
      builder: (context, value, child) {
        ...
        return IconButton(
          icon: icon,
          onPressed: () {
            _postsProvider.onRepeatButtonPressed(_postsProvider.recommendersAudioPlayer);
          }, 
        );
      },
    );
