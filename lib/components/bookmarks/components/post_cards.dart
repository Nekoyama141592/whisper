            ...
            child: ListView.builder(
              ...
              itemBuilder: (BuildContext context, int i) {
                ...
                PostCard(
                  ...
                  muteUser: () async {
                    await voids.muteUser(audioPlayer: bookmarksModel.audioPlayer, afterUris: bookmarksModel.afterUris, mutesUids: mainModel.mutesUids, i: i, results: bookmarksModel.posts, muteUsers: mainModel.muteUsers, post: post, mainModel: mainModel);
                  },
                  mutePost: () async {
                  ...
                  blockUser: () async {
                    await voids.blockUser(audioPlayer: bookmarksModel.audioPlayer, afterUris: bookmarksModel.afterUris, blocksUids: mainModel.blockUids, blockUsers: mainModel.blockUsers, i: i, results: bookmarksModel.posts, post: post, mainModel: mainModel);
                  },
                  mainModel: mainModel,
                );
              }
