      ...
      child: Slidable(
        ...
        [
          IconSlideAction(
            ...
            onTap: () async {
              await postSearchModel.muteUser(mainModel.mutesUids, result['uid'], mainModel.prefs, i, mainModel.currentUserDoc);
            } ,
          ),
          IconSlideAction(
            caption: 'mute Post',
          ...
          IconSlideAction(
            ...
            icon: Icons.block,
            onTap: () async {
              await postSearchModel.blockUser(mainModel.currentUserDoc, mainModel.blockingUids, result['uid'], i);
            },
          ),
        ] : deleteIcon,
        child: Container(
