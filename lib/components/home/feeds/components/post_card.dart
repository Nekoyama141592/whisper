      ...
      child: Slidable(
        ...
        [
          IconSlideAction(
            ...
            onTap: () async {
              await feedsModel.muteUser(mainModel.mutesUids, postDoc['uid'], mainModel.prefs, i, mainModel.currentUserDoc);
            } ,
          ),
          IconSlideAction(
            caption: 'mute Post',
            ...
            onTap: () async {
              await feedsModel.mutePost(mainModel.mutesPostIds, postDoc['postId'], mainModel.prefs, i);
            },
          ),
          IconSlideAction(
            caption: 'block User',
