...
WhisperUser _$WhisperUserFromJson(Map<String, dynamic> json) => WhisperUser(
      ...
      bioPostiveScore: json['bioPostiveScore'] as num,
      ...
      userNamePostiveScore: json['userNamePostiveScore'] as num,
...
Map<String, dynamic> _$WhisperUserToJson(WhisperUser instance) =>
    <String, dynamic>{
      ...
      'bioPostiveScore': instance.bioPostiveScore,
      ...
      'userNamePostiveScore': instance.userNamePostiveScore,
