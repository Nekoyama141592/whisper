...
const String reflectChangesMsg = 'いいねボタンや目のボタンを押すと反映されます';
// Id
...
const String decideModalText = '決定';
const String sendModalText = '送信';
...
const String deleteCommentText = '自分のコメントを完全に削除';
const String deleteReplyText = '自分のリプライを完全に削除';
const String sortText = '並び替え';
const String sortCommentText = 'コメントを並び替えます';
const String sortReplyText = 'リプライを並び替えます';
...
const String selectOperationText = '行う操作を選択';
