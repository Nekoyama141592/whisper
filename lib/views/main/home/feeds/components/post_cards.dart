          ...
          onLoading: () async => await mainModel.onLoading(),
            child: ListView.builder(
              ...
              itemBuilder: (BuildContext context, int i) {
                ...
                PostCard(
                  postDoc: postDoc,
                  onDeleteButtonPressed: () => mainModel.onPostDeleteButtonPressed(context: context, audioPlayer: mainModel.audioPlayer, whisperPost: whisperPost, afterUris: mainModel.afterUris, posts: mainModel.posts, mainModel: mainModel, i: i),
                  initAudioPlayer: () async => await mainModel.initAudioPlayer(audioPlayer: mainModel.audioPlayer, afterUris: mainModel.afterUris, i: i),
                  muteUser: () async => await mainModel.muteUser(context: context,audioPlayer: mainModel.audioPlayer, afterUris: mainModel.afterUris, muteUids: mainModel.muteUids, i: i, results: mainModel.posts, muteUsers: mainModel.muteUsers, whisperPost: whisperPost, mainModel: mainModel),
                  mutePost: () async => await mainModel.mutePost(context: context,mainModel: mainModel, i: i, postDoc:postDoc, afterUris: mainModel.afterUris, audioPlayer: mainModel.audioPlayer, results: mainModel.posts ),
                  reportPost: () => mainModel.reportPost(context: context, mainModel: mainModel, i: i, post: whisperPost, afterUris: mainModel.afterUris, audioPlayer: mainModel.audioPlayer, results: mainModel.posts ),
                    ...
                    return CupertinoActionSheet(
                      ...
                      [  
                        CupertinoActionSheetAction(onPressed: () {
                          ...
                          mainModel.onPostDeleteButtonPressed(context: context, audioPlayer: mainModel.audioPlayer, whisperPost: whisperPost, afterUris: mainModel.afterUris, posts: mainModel.posts, mainModel: mainModel, i: i);
                      ...
                      : [
                        CupertinoActionSheetAction(onPressed: () async {
                          Navigator.pop(innerContext);
                          await mainModel.muteUser(context: context, audioPlayer: mainModel.audioPlayer, afterUris: mainModel.afterUris, muteUids: mainModel.muteUids, i: i, results: mainModel.posts, muteUsers: mainModel.muteUsers, whisperPost: whisperPost, mainModel: mainModel);
                        }, child: PositiveText(text: muteUserText(context: context)) ),
                        CupertinoActionSheetAction(onPressed: () async {
                          Navigator.pop(innerContext);
                          await mainModel.mutePost(context: context, mainModel: mainModel, i: i, postDoc:postDoc, afterUris: mainModel.afterUris, audioPlayer: mainModel.audioPlayer, results: mainModel.posts);
                        }, child: PositiveText(text: mutePostText(context: context)) ),
                        CupertinoActionSheetAction(onPressed: () {
                          Navigator.pop(innerContext);
                          mainModel.reportPost(context: context, mainModel: mainModel, i: i, post: whisperPost, afterUris: mainModel.afterUris, audioPlayer: mainModel.audioPlayer, results: mainModel.posts);
